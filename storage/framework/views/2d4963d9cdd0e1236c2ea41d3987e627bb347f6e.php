<section id="nav-bar">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link" href="<?php echo e(route('about')); ?>">Review</a>
        </li>
  ...
  </section><?php /**PATH C:\xampp\htdocs\Online Tours and Travels Management\resources\views/layouts/frontend/inc/nav.blade.php ENDPATH**/ ?>