...
<div class="container-fluid plan">
    ...
    <div class="row text-center">
        ...
        <div class="col-md-4">
            ...
            <p>We organized all packages. Our team is very responsible.We organized single tour and package tour. </p>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Online Tours and Travels Management\resources\views/welcome.blade.php ENDPATH**/ ?>