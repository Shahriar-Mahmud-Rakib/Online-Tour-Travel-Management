            ...
            <div class="col-md-9">
                <div class="card mt-5">
                  ...
                  <?php echo $__env->make('partial.errors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <form action="<?php echo e(route('admin.place.update', $place->id)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
					        <div class="form-group">
					          <label for="name"> Name: </label>
					          <input type="text" class="form-control" value="<?php echo e(old('name', $place->name)); ?>" placeholder="Enter Name" id="name" name="name">
					        </div>
					        <div class="form-group">
                                  ...
                                  <option value="">select any district</option>
                                     <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($district->id); ?>"
                                            <?php echo e($place->district_id == $district->id ? 'selected' : ''); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="placetype_id" id="type" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $placetypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $placetype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option  value="<?php echo e(old('placetype_id', $placetype->id)); ?>"
                                            <?php echo e($place->placetype_id == $placetype->id ? 'selected' : ''); ?>>
                            ...
                            <div class="form-group">
                                ...
                                <input id="description" type="hidden" name="description" value="<?php echo e(old('description',$place->description)); ?>">
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Online Tours and Travels Management\resources\views/admin/place/edit.blade.php ENDPATH**/ ?>